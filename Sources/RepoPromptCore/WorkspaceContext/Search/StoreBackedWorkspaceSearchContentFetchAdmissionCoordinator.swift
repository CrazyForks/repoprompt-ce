...
package actor StoreBackedWorkspaceSearchContentFetchAdmissionCoordinator {
    package struct Configuration: Equatable {
        ...
        package let fairSharePerStore: Int
        package let maxBurstPerStore: Int
    ...
    package static let shared = StoreBackedWorkspaceSearchContentFetchAdmissionCoordinator()
        ...
        package struct DebugSnapshot: Equatable {
            package struct LaneLoad: Equatable {
                ...
                package let queuedSearchCount: Int
            }
    ...
    package func withContentFetchPermit<T>(
        ...
        let waitState = WorkspaceRuntimePerf.begin(
            WorkspaceRuntimePerf.Stage.Search.contentFetchAdmissionWait,
    ...
    private func enqueueWaiter(
        ...
        WorkspaceRuntimePerf.lifecycleEvent(
            WorkspaceRuntimePerf.Lifecycle.Search.contentFetchWaitBegan,
    ...
    private func cancelWaiter(id: UUID, for storeKey: ObjectIdentifier) {
        ...
        WorkspaceRuntimePerf.lifecycleEvent(
            WorkspaceRuntimePerf.Lifecycle.Search.contentFetchPermitCancelled,
    ...
    private func expireWaiter(id: UUID, for storeKey: ObjectIdentifier) {
        ...
        waitExpiryCount &+= 1
        WorkspaceRuntimePerf.lifecycleEvent(
            WorkspaceRuntimePerf.Lifecycle.Search.contentFetchWaitExpired,
            correlation: state.lifecycleCorrelation,
            admissionDimensions(
                outcome: "waitExpired",
                metrics: metrics(for: storeKey),
    ...
    private func release(_ acquisition: PermitAcquisition) {
        ...
        WorkspaceRuntimePerf.lifecycleEvent(
            WorkspaceRuntimePerf.Lifecycle.Search.contentFetchPermitReleased,
    ...
    private func recordPermitAcquired(_ acquisition: PermitAcquisition) {
        WorkspaceRuntimePerf.lifecycleEvent(
            WorkspaceRuntimePerf.Lifecycle.Search.contentFetchPermitAcquired,
            correlation: acquisition.lifecycleCorrelation,
            admissionDimensions(
                outcome: acquisition.waited ? "acquiredAfterWait" : "immediate",
                metrics: acquisition.metrics,
    ...
    private func recordOverload(
        ...
        overloadCount &+= 1
        WorkspaceRuntimePerf.lifecycleEvent(
            WorkspaceRuntimePerf.Lifecycle.Search.contentFetchOverloaded,
            correlation: lifecycleCorrelation,
            admissionDimensions(
