...
package struct CodeMapGenerator {
    package static let debug = false
    ...
    package static let debugLogging = false
    ...
    package static func generateCodeMap(
    ...
    package static func computeLineBoundaries(content: String) -> [Int] {
    ...
    package static func lineNumber(for location: Int, using boundaries: [Int]) -> Int {
